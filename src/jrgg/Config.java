				...
				if (!ControlFile.backups.isEmpty()) {
					...
					if ((i >= 0) && (i < ControlFile.backups.size())) {
						...
						if ((j > 0) && (j < 5)) {
							...
							switch (j) {
							case 1:
								ControlFile.backups.get(i).setNome(newval);
								break;
							case 2:
								ControlFile.backups.get(i).setDiretorio(newval);
								break;
							case 3:
								ControlFile.backups.get(i).setFormato(newval);
								break;
							case 4:
								byte a = Byte.parseByte(newval);
...
/**
 * 
 /backup/aes backup_AES01CDom0_aaaa_mm_dd_hh_MM_ss.tgz
 * backup_AES02CDom0_aaaa_mm_dd_hh_MM_ss.tgz
 * 
 * /backup/cm backup_AACMACDom0_aaaa_mm_dd_hh_MM_ss.tgz
 * backup_AACMACDom0_aaaa_mm_dd_hh_MM_ss.tgz
 * backup_AACMESSCDom0_aaaa_mm_dd_hh_MM_ss.tgz full_AACMA_040001_aaaammdd.tar.gz
 * full_AACMB_040001_aaaammdd.tar.gz full_AACMESS_105209_aaaammdd.tar.gz
 * 
 * /backup/cms CMS-aammdd-01-LSAC-00-F-01-05-CMS010000000000
 * CMS-aammdd-01-LSAC-00-F-01-05-CMS020000000000
 * 
 * /sbce 07-02-2015_13-18-57_6.3.2-08-5478.zip repo.xml
 * 07-02-2015_15-53-34_6.3.2-08-5478.zip
 * 
 * 
 * /smgr backup_SMGR01CDom0_2015_07_02_12_31_03.tgz
