...
public class ControlFile {
	...
	public static void criarBackup(String nome, String diretorio,
			String formato, int qndSalva) {
	...
	public static void listar() {
		...
		if (!backups.isEmpty()) {
			for (Backup b : backups) {
				System.out.println("[" + x++ + "] nome: " + b.nome
						+ "  |diretorio: " + b.diretorio + "  |formato: "
						+ b.formato + "  |qnt_salva: " + b.qndSalva);
			}
		} else {
